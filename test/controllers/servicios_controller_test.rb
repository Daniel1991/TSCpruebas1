...
class ServiciosControllerTest < ActionController::TestCase
  ...
  test "should create servicio" do
    assert_difference('Servicio.count') do
      post :create, servicio: { descripcion: @servicio.descripcion, direccion: @servicio.direccion, disponibilidad: @servicio.disponibilidad, email: @servicio.email, fecha: @servicio.fecha, identificacion: @servicio.identificacion, nombre: @servicio.nombre, pedidoN: @servicio.pedidoN, telefono: @servicio.telefono, tipoServicio_id: @servicio.tipoServicio_id }
    end
  ...
  test "should update servicio" do
    patch :update, id: @servicio, servicio: { descripcion: @servicio.descripcion, direccion: @servicio.direccion, disponibilidad: @servicio.disponibilidad, email: @servicio.email, fecha: @servicio.fecha, identificacion: @servicio.identificacion, nombre: @servicio.nombre, pedidoN: @servicio.pedidoN, telefono: @servicio.telefono, tipoServicio_id: @servicio.tipoServicio_id }
    assert_redirected_to servicio_path(assigns(:servicio))
  end
